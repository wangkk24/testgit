 ...
 * @Title: EventLogger
 * @Package com.pukka.ydepg.util
 * @date 2017/12/17 20:27
 */
public class EventLogger implements Player.EventListener,
    MetadataOutput, AudioRendererEventListener,
    VideoRendererEventListener, DefaultDrmSessionManager.EventListener {
  ...
  @Override public void onPlaybackParametersChanged(PlaybackParameters playbackParameters) {
    if(isDebug){
      Log.d(TAG,
          "playbackParameters " + String.format("[speed=%.2f, pitch=%.2f]", playbackParameters.speed,
        ...
        if (rendererTrackGroups.length > 0) {
          ...
          for (int groupIndex = 0; groupIndex < rendererTrackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < trackGroup.length; trackIndex++) {
              ...
              Log.d(TAG, "      " + status + " Track:" + trackIndex + ", " + Format.toLogString(
  ...
  private void printMetadata(Metadata metadata, String prefix) {
    for (int i = 0; i < metadata.length(); i++) {
      ...
      if (entry instanceof TextInformationFrame) {
        ...
        Log.d(TAG,
            prefix + String.format("%s: mimeType=%s, filename=%s, description=%s", geobFrame.id,
                geobFrame.mimeType, geobFrame.filename, geobFrame.description));
        ...
        Log.d(TAG,
            prefix + String.format("EMSG: scheme=%s, id=%d, value=%s", eventMessage.schemeIdUri,
                eventMessage.id, eventMessage.value));
      }
    }
  }
  ...
  @SuppressWarnings("ReferenceEquality") private static String getTrackStatusString(
