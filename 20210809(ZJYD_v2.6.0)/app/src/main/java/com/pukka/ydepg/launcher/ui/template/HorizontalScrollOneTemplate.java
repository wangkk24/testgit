 ...
 */
public class HorizontalScrollOneTemplate extends PHMTemplate {
    ...
    public HorizontalScrollOneTemplate(Context context, int layoutId, PHMFragment fragment, OnFocusChangeListener focusChangeListener) {
    ...
    public void setDatas(List<Element> elementList, List<VOD> vodList, Group group) {
        ...
        CommonAdapter adapter = new CommonAdapter<Element>(context, R.layout.item_horizontal_scroll_one, elementList) {
            @Override
