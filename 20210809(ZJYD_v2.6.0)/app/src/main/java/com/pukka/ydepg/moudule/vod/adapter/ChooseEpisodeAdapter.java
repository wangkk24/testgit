 ...
 * @date: 2017-12-19
 */
public class ChooseEpisodeAdapter extends RecyclerView.Adapter<ChooseEpisodeAdapter.ViewHolder> implements EpisodeAdapter {
    ...
    public ChooseEpisodeAdapter(List<Episode> episodes, DetailPresenter presenter) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_detail_choose_episode, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //HeartBeatUtil.getInstance().isEpisodeShowVip(episode.getVOD(), mPresenter.getVODDetail()==null?"":mPresenter.getVODDetail().getPrice())&&(TextUtils.isEmpty(showEpisodeVIPMark)||"1".equals(showEpisodeVIPMark))
