...
/**
 * Created by Eason on 11/21/2018.
 */

public class CustomRoundImageView extends ImageViewExt {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        radius = array.getDimensionPixelOffset(R.styleable.Custom_Round_Image_View_radius_imageview, defaultRadius);
