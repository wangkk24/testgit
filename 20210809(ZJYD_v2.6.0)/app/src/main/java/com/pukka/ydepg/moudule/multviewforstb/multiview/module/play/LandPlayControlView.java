...
public class LandPlayControlView extends PlayControlView {
    ...
    public LandPlayControlView(@NonNull Context context) {
        super(context);
    }

    public LandPlayControlView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public LandPlayControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected void initView(Context mContext) {
        rootView = LayoutInflater.from(mContext).inflate(R.layout.play_control, this, true);
