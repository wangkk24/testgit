...
public class EffectNoDrawBridge extends OpenEffectBridge {
	...
	@Override
    public void onFocusView(final View focusView, final View oldView, final float scaleX, final float scaleY) {
		if (!isAnimEnabled())
			return;
		if (focusView != null) {
			/**
			 ...
			 * 你可以写自己的动画效果. <br>
			 */
            runTranslateAnimation(focusView, oldView, scaleX, scaleY);
