...
public class NewChildTotalEpisodeAdapter extends RecyclerView.Adapter<NewChildTotalEpisodeAdapter.ViewHolder>{
    ...
    public NewChildTotalEpisodeAdapter(List<List<String>> episodes, EpisodeAdapter chooseAdapter, int rate,boolean isChildMode, RecyclerView recyclerView) {
