...
//    public static String upgrade = "http://124.70.66.212:33500/UPGRADE";
    ...
    public void showUpdateAskDialog(String version, final String filename) {
        ...
        askDialogBuilder.setMessage("是否升级到最新版本?");
        askDialogBuilder.setNegativeButton("确定", new DialogInterface.OnClickListener() {
            @Override
        ...
        askDialogBuilder.setPositiveButton("取消", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
    ...
    public void showForceUpdateDialog(String version, final String filename) {
        ...
        forceDialogBuilder.setMessage("是否升级到最新版本?");
        forceDialogBuilder.setNegativeButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                showApkDownloadDialog();
                UpgradeHelper.setUpgradeDelegate(new UpdateIUpgrade());
    ...
    public void showApkDownloadDialog() {
        ...
        progressDialog.setMessage("正在下载安装包...");//对话框消息
