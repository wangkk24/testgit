...
public class QRCodeGenerator {
     ...
     * @return 合成后的bitmap
     */
    public static Bitmap createQRImage(String data, int width, int height, Bitmap logoBm) {
...
//            BitMatrix bitMatrix = new QRCodeWriter().encode(data, BarcodeFormat.QR_CODE, widthPix, heightPix, hints);
            ...
            SuperLog.error("createQRImage(",e);
        }
