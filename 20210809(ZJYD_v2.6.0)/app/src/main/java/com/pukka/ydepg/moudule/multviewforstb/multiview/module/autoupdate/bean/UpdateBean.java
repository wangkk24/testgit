...
import com.pukka.ydepg.moudule.multviewforstb.multiview.module.autoupdate.util.ApplicationUtil;
...
public class UpdateBean {
    ...
    public boolean hasUpdate() {
        if (null != TVApplication.getInstance().getUpdateBean()) {
            String version = TVApplication.getInstance().getUpdateBean().getVersion().trim();
            try {
