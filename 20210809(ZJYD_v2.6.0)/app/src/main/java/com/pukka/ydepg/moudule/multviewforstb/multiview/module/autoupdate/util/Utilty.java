...
//    }
    ...
    public static String getVersionCode() {
        PackageManager manager = TVApplication.getContext().getApplicationContext().getPackageManager();
        try {
            PackageInfo info = manager.getPackageInfo(TVApplication.getContext().getPackageName(), 0);
