...
public class UpgradeHelper {
    ...
    private static String deviceType = "STB_VR";
//    private static String deviceType = "STB_ZYSJ";
    ...
    public static void installApk(String filePath) {
        ...
        VRPlayerApplictaion.getContext().startActivity(intent);
        System.exit(0);
    }
    ...
    public static void downloadConfigFile(String url) {
        File apkFile = new File(VRPlayerApplictaion.getContext().getExternalFilesDir((String) null), configFileName);
        if (apkFile.exists()) {
            apkFile.delete();
        }
    ...
    public static void downloadApk(String fileName) {
        File apkFile = new File(VRPlayerApplictaion.getContext().getExternalFilesDir((String) null), upgradeApkName);
        if (apkFile.exists()) {
            apkFile.delete();
        }
