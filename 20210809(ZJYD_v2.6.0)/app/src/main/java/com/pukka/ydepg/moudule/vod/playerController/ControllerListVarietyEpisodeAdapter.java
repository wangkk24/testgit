...
public class ControllerListVarietyEpisodeAdapter extends RecyclerView.Adapter<ControllerListVarietyEpisodeAdapter.ViewHolder>implements ControllerEpisodeAdapter{
    private static final String TAG = "ControllerListVarietyEp";
    ...
    public ControllerListVarietyEpisodeAdapter(List<Episode> mEpisodeList,List<String> mEpisodeCountList , String fatherPrice, BrowseEpsiodesUtils utils, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_window_controller_variety_item, parent, false);
...
//        }
        ...
        if (null != mEpisodeList && mEpisodeList.size() > position ){
            ...
            if (!TextUtils.isEmpty(episode.getSitcomNO())&&!TextUtils.isEmpty(episode.getVOD().getName())) {
                holder.title.setText(/**"第"+episode.getSitcomNO()+"期   "+**/episode.getVOD().getName());
            }
            ...
            bg.setOnFocusChangeListener(new View.OnFocusChangeListener() {
                ...
                public void onFocusChange(View v, boolean hasFocus) {
                    ...
                    if (hasFocus){
                        ...
                        title.setTextColor(mContext.getResources().getColor(R.color.c38_color));
                    }
