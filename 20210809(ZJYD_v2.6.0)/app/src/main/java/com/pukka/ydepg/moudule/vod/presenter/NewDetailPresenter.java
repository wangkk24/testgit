...
public class NewDetailPresenter extends BasePresenter implements Presenter {

    public static final String TAG = NewDetailPresenter.class.getName();
    private NewDetailDataView mDetailDataView;
    ...
    public NewDetailPresenter(RxAppCompatActivity rxAppCompatActivity) {
    ...
    public void setDetailDataView(NewDetailDataView detailDataView) {
        mDetailDataView = detailDataView;
    }

    public void setFullScreen(boolean isFullScreen, String contentId) {
...
//            queryFavoCatalog(mQueryFavoCatalogCallback);
    ...
    private PlayURLCallBack playURLCallBack = new PlayURLCallBack() {
        ...
        public void getVODPlayUrlSuccess(String playUlr, String mbookmark, String productId, String elapseTime) {
            SuperLog.debug(TAG, "orderFinish: playSuccess");
            ...
            if (mVODDetail != null) {
                if (!TextUtils.isEmpty(playUlr)) {
                    ...
                    Log.i(TAG, "getVODPlayUrlSuccess: initFragment  获取广告");
        ...
        public void playFail(PlayVODResponse response) {
            SuperLog.debug(TAG, "orderFinish: playFail");
            EventBus.getDefault().post(new FinishPlayUrlEvent());
            ...
            if (!TextUtils.isEmpty(returnCode) && (returnCode.equals("144020008") || returnCode.equals("504") || returnCode.equals("114020006"))) {
                ...
                Log.i(TAG, "zixuan playUrl playFail: " + playUrl);
...
//                    mOrderOrSee = false;
                    ...
                    if (null != needJumpToH5Order && needJumpToH5Order.equals("1")) {
                        ...
                        //pbs点击上报
                        SuperLog.debug(TAG, "PbsUaService: " + mVODDetail.getID());
...
//        Log.i(TAG, "switchPlayerView: initFragment "+ playVodBean.getPlayUrl());
        //TODO 跳转到播放界面
//        Intent intent = new Intent(OTTApplication.getContext(), OnDemandVideoActivity.class);
        Intent intent = new Intent(OTTApplication.getContext(), NewVodDetailActivity.class);
        /**
        ...
        if (isChildMode && rxAppCompatActivity != null && rxAppCompatActivity instanceof ChildModeVodDetailActivity) {
            ...
            if (isFullScreen) {
                intent.putExtra(NewVodDetailActivity.VOD_ID, mContentId);
...
//            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            OTTApplication.getContext().startActivity(intent);
                Log.i(TAG, "onSuccess: initFragment startPlay");
                mDetailDataView.startPlay();
            }
        }
    }
    ...
    IADListener iadListener = new IADListener() {
        ...
        public void onSuccess(List<AdvertContent> listAdvertContent) {
            Log.i(TAG, "onSuccess: initFragment 广告成功");
        ...
        @Override
        public void onFail() {
            Log.i(TAG, "onSuccess: initFragment 广告失败");
            switchPlayerView();
        }
    };
